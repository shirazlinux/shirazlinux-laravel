    ...
    public static function defaultSlides(): array
    {
        return [
            [
                ...
                'alt' => 'دسته‌جمعی شرکت‌کنندگان نشست سوم شیرازلینوکس',
                'url' => '/tags/event',
                'enabled' => true,
            ],
            [
                ...
                'title' => 'دورهمی حضوری',
                'alt' => 'دسته‌جمعی شرکت‌کنندگان افتتاحیه جامعه لینوکسی شیراز',
                'url' => '/tags/dorehami',
                'enabled' => true,
            ],
            [
                ...
                'alt' => 'دسته‌جمعی شرکت‌کنندگان همایش گنولینوکس شیراز',
                'url' => '/tags/workshop',
                'enabled' => true,
            ],
            [
